...
int Fun4All_AnaTutorial_Intt(
    const int nEvents = 1000, //5,
    const string &inputFile = "https://www.phenix.bnl.gov/WWW/publish/phnxbld/sPHENIX/files/sPHENIX_G4Hits_sHijing_9-11fm_00000_00010.root",
    const string &outputFile = "dst_intt_run20869.root",
...
//--  if (Enable::TOPOCLUSTER) TopoClusterReco();
  ...
  InttRawData *inttraw = new InttRawData("Inttraw",
					 ...
					 "/sphenix/lustre01/sphnxpro/commissioning/INTT/tmp/beam_inttall-00020869-0000_event_base_ana.root"
  );
